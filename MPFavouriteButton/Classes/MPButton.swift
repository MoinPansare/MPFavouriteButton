...
public class MPButton: UIButton {
    ...
    private func createLayers(image image: UIImage!) {
        ...
        let imgCenterPoint = CGPoint(x: imageFrame.size.width / 2, y: imageFrame.size.height / 2)
    ...
    func touchDown(sender: MPButton) {
        self.layer.opacity = 0.4
    }
    func touchUpInside(sender: MPButton) {
        self.layer.opacity = 1.0
    }
    func touchDragExit(sender: MPButton) {
        self.layer.opacity = 1.0
    }
    func touchDragEnter(sender: MPButton) {
        self.layer.opacity = 0.4
    }
    func touchCancel(sender: MPButton) {
        self.layer.opacity = 1.0
    }
